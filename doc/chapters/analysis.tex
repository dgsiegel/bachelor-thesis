...
using a mail address. The real challenge however is the limit of 100 API calls
per hour. If a user is logged in, the user has 100 calls, which he can use on
...
visualisation of a user, 100 calls are not enough, as for example many users
have more than 100 friends. However, there are three ways around this problem:
...
address after 100 calls. However, some API methods require the user to be
logged in.
