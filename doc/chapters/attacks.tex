...
\begin{itemize}
  \item Name and employee number of a bank employee of the wire transfer room
  \item Name, department, employee number of a bank employee outside the wire
  \item Phone number of wire transfer room
  \item Current wire transfer code
\end{itemize}
