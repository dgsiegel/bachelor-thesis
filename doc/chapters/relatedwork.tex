...
\begin{quote}
\textit{\glqq{}A Term for cracking techniques that rely on weaknesses in
...
shows. The social engineer can of course be also the hacker. \cite{jones2003}
...
%\begin{description}[\setlabelphantom{Test security}]
\begin{description}
