...
\begin{frame}[t]{Prototyp - API Call}
  \vspace{-0.85em}
  \begin{center}
    \includegraphics[height=0.82\textheight]{prototype_state.1}
  \end{center}
\end{frame}
...
\begin{frame}[t]{Prototyp - Plugin}
  \vspace{-0.85em}
  \begin{center}
    \includegraphics[height=0.82\textheight]{prototype_activity.1}
  \end{center}
\end{frame}
